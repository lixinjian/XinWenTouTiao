...
public class SettingUtil {
    ...
    private SharedPreferences setting = PreferenceManager.getDefaultSharedPreferences(MyApplication.getContext());
...
//        return setting.getBoolean("switch_noPhotoMode", false) && NetWorkUtil.isMobileConnected(MyApplication.getContext());
//    }
     ...
     */
    public int getColor() {
        int defaultColor = MyApplication.getContext().getResources().getColor(R.color.colorPrimary);
